...
@section('main')
    ...
    <div class="modal" id="kibModal" tabindex="-1" aria-labelledby="kibModalLabel" aria-hidden="true" data-backdrop="static">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-4">
                                    ...
                                    <input type="text" name="harga_per_unit" id="harga_per_unit" class="form-control" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <input type="hidden" name="year" id="year" class="form-control" value="2024" readonly>
                                </div>
                                <div class="col-6">
